...
const backendApi = new Function(backend + '\nreturn { findActivityLayout, activityFingerprint, buildOllamaChatUrl, directOllamaModelName };')();
...
const requiredActions = ['getWorkData', 'setupDatabase', 'migrateLegacyData', 'saveActivity', 'deleteActivity', 'saveTask', 'deleteTask', 'saveSubtask', 'deleteSubtask', 'saveDocument', 'deleteDocument', 'saveNote', 'deleteNote', 'verifyLocalDev', 'updateLGU', 'askAI'];
...
const requiredIds = ['view-work', 'calendarGrid', 'activitiesTableBody', 'personalTaskGrid', 'teamTaskGrid', 'documentsTableBody', 'notesGrid', 'modalActivity', 'modalDocument', 'modalNote', 'modalTask', 'taskSubtaskList', 'taskStartedAt', 'taskCompletedAt', 'workLocalSyncButton'];
